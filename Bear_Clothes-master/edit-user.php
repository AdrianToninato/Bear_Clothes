...
if (isset($_GET['id'])): // Se o id na url existe é porque deu certo.
    ...
    $dados = mysqli_fetch_array($result); // Obtendo todas as informações do colaborador a partir do id.
endif;
...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <form action="update.php" method="post" id="edit_user">

            <div class="form-group">
                <input type="hidden" value="<?php echo $dados['cdUser']; ?>" name="id">
                <label>Nome:</label>
                <input type="text" name="nome" id="user_nome" class="form-control" value="<?php echo $dados['name']; ?>">
                <p id="legenda_userNome" class="erro_legenda"></p>
            </div>
            <div class="form-group">
                <label>Usuário:</label>
                <input type="text" name="usuario" id="user_usuario" class="form-control" value="<?php echo $dados['email']; ?>">
                <p id="legenda_userUsuario" class="erro_legenda"></p>
            </div>
            <input type="submit" class="btn btn-warning" name="btn-atualizar-user" value="Atualizar">
        </form>
