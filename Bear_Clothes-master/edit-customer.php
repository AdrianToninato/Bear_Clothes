...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <form action="update.php" method="post" id="edit_customer">

            <div class="form-group">
                <input type="hidden" value="<?php echo $dados['cdCustomer']; ?>" name="id">
                <label>Nome:</label>
                <input type="text" name="nome" id="customer_nome" class="form-control" value="<?php echo $dados['name']; ?>">
                <p id="legenda_customerNome" class="erro_legenda"></p>
            </div>
            <div class="form-group">
                <label>Usuário:</label>
                <input type="text" name="usuario" id="customer_usuario" class="form-control" value="<?php echo $dados['email']; ?>">
                <p id="legenda_customerUsuario" class="erro_legenda"></p>
            </div>
