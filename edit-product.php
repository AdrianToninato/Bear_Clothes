    ...
    <div class="container mt-5 mb-5">
        ...
        <form action="update-product.php" method="post">
            <div class="form-group">
                ...
                <input type="text" name="name_product" class="form-control" value="<?php echo $dados['nome']; ?>">
            </div>
            <div class="form-group">
                <label>Imagem:</label>
                <input type="text" name="img_product" class="form-control" value="<?php echo $dados['img']; ?>">
            </div>
            <div class="form-group">
                <label>Página:</label>
                <input type="text" name="link_product" class="form-control" value="<?php echo $dados['link']; ?>">
            </div>
            <div class="form-group">
                <label>Descrição:</label>
                <input type="text" name="description_product" class="form-control" value="<?php echo $dados['descricao']; ?>">
            </div>
            <div class="form-group">
                <label>Preço:</label>
                <input type="text" name="value_product" class="form-control" value="<?php echo $dados['preco']; ?>">
            </div>
